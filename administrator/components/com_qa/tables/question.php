 ...
 * @since		1.5
 */
class QATableQuestion extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__qa_questions', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		else
		{
			...
			// Get the old row
			$oldrow = JTable::getInstance('Question', 'QATable');
			...
			$table = JTable::getInstance('Question', 'QATable');
