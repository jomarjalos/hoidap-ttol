 ...
 * @since		1.5
 */
class QATableTutorial extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__qa_tutorials', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		else
		{
			...
			// Get the old row
			$oldrow = JTable::getInstance('Tutorial', 'QATable');
			...
			$table = JTable::getInstance('Tutorial', 'QATable');
