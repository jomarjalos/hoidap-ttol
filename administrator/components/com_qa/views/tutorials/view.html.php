...
/**
 * View class for a list of tutorials.
 *
 * @package     Joomla.Administrator
 * @subpackage  com_qa
 * @since       1.6
 */
class QAViewTutorials extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('Tutorial Manager: Tutorials'), 'tutorials.png');
//		if (count($user->getAuthorisedCategories('com_qa', 'core.create')) > 0)
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			if ($this->state->get('filter.state') != -1)
			{
				...
				{
					JToolBarHelper::unarchiveList('tutorials.publish');
				}
			}
		}
