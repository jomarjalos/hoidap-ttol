...
/**
 * Methods supporting a list of tip records.
 *
 * @package		Joomla.Administrator
 * @subpackage	com_qa
 * @since		1.6
 */
class QAModelTips extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__qa_tips').' AS a');
		
		// select count
		$query->select('(SELECT COUNT(id) FROM #__qa_tip_answers WHERE tip_id = a.id) AS count_answers');
