 ...
 * @since		1.6
 */
class QAModelQuestions extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__qa_questions').' AS a');
		
		// select count
		$query->select('(SELECT COUNT(id) FROM #__qa_question_answers WHERE question_id = a.id) AS count_answers');
