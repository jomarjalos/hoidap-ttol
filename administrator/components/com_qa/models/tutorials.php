...
/**
 * Methods supporting a list of tutorial records.
 *
 * @package		Joomla.Administrator
 * @subpackage	com_qa
 * @since		1.6
 */
class QAModelTutorials extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__qa_tutorials').' AS a');
		
		// select count
		$query->select('(SELECT COUNT(id) FROM #__qa_tutorial_answers WHERE tutorial_id = a.id) AS count_answers');
...
//		$query->join('LEFT', $db->quoteName('#__languages').' AS l ON l.lang_code = a.language');
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'Album', $prefix = 'QATable', $config = array())
	{
